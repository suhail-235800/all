...
public class LetterCombinations {
    ...
    public static List<String> generateCombinations(String number){
        ...
        for(int n=0;n<number.length()-1;n++) {
            List<String> firstdigit = allcombinations.get(String.valueOf(number.charAt(n)));
            List<String> seconddigit = allcombinations.get(String.valueOf(number.charAt(n + 1)));
    ...
    public static void main(String args[]){
        ...
        System.out.println(generateCombinations("234"));
